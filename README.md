...
2.5 (Easy setup) In the root directory, run `npm run setup`
...
3.5 (Easy run) In the root directory, run `npm run dev`
...
7. Run gen.py with python to generate the tests
8. Rerun/refresh. You should see 2k or more tests!
